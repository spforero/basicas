...
<div class="cont rounded-t-lg my-3 "> 
    <p class="text-center text-white font-serif- font-bold text-3xl">Reporte</p>
...
<div class="m-8 rounded bg-blue-200">
  <div class="flex p-8">
    <label for="username" class="text-info mx-8 text-black font-serif font-bold p-2" style="color: #100F4C">Fecha</label>
    <input type="text" name="username" id="Fecha" class="form-control rounded shadow-lg p-2">

    <label for="username" class="text-info mx-8 text-black font-serif font-bold p-2 " style="color: #100F4C">Año</label>
    <input type="text" name="username" id="año" class="form-control rounded shadow-lg p-2">
  ...
  <table class="border-2 border-black table-fixed w-full" >
    <thead class="cont">
      <tr class="text-white font-serif text-sm">
        ...
        <th class="border-2 border-black px-4 py-2" >Fecha</th>
        <th class="border-2 border-black px-4 py-2" >Año</th>
    ...
    <div class="flex justify-end p-4 pl-96 ">
        <input type="submit" name="Imprimir" class="btn btn-info btn-md text-white font-serif font-bold bg-blue-900 rounded-lg p-2 m-4 hover:bg-blue-500" value="Imprimir reporte" >
        <input type="submit" name="Descargar" class="btn btn-info btn-md text-white font-serif font-bold p-2 bg-blue-900 rounded-lg m-4 hover:bg-blue-500" value="Descargar reporte">
    </div>
</div>
