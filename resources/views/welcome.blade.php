...
<body>
 <div class="cont bg-blue-900  flex ">
    ...
    <a  class="text-xl font-bold my-20 ml-64 text-white font-serif object-right hover:text-blue-700" href="">Iniciar Sesionjjjjjjjjvgit</a>

 </div>

 <div class="container h-full bg-blue-100 mt-4 mb-4 ml-10 rounded-xl shadow-2xl">
     <h1 class="text-3xl font-bold text-center pt-4  mb-4">Bienvenidos a nuestra comunidad Unisangilista jgvgvgv</h1>
